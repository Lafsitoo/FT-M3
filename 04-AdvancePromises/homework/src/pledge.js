...
$Promise.prototype.then = function (successCb, errorCb) {
  ...
  if (this._state !== "pending") this._callHeanders();

  return downstreamPromise;
};

$Promise.prototype._callHeanders = function () {
    ...
    if (this._state === "fulfilled") {
      ...
      if (!handler.successCb) {
        ...
        try {
          ...
          // Si arroja un error va al catch, y no lee nada más de lo que haya dentro de "try"
